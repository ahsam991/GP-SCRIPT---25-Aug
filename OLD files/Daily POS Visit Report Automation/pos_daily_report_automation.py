...
DB_PARAMS = {
    "dbname": "gp_dev",
    "user": "report_user",
    # "password": "report#Gp*User!#__D",  # ⚠️ CREDENTIAL - do not commit
    "password": "",
    # "host": "gp-stg.cf44ysgum7u8.ap-southeast-1.rds.amazonaws.com",  # ⚠️ CREDENTIAL - do not commit
    "host": "",
...
def send_email_with_attachments(subject, body, to_emails, cc_emails, attachments):
    # from_email = "shadman.sayeid@v2.ltd"  # ⚠️ CREDENTIAL - do not commit
    from_email = ""
    # email_password = "ujmt gpgi ctbx dohe"  # ⚠️ CREDENTIAL - do not commit
    email_password = ""
    # group_mail = "cockpit.glm@v2.ltd"  # ⚠️ CREDENTIAL - do not commit
    group_mail = ""
...
if __name__ == "__main__":
    ...
    # # # Directly set the email recipients here  ⚠️ CREDENTIAL - do not commit
    # to_emails = ['saju@ims.net.bd','rakib@ims.com.bd','dip@asiaticexp.com','obydur.gpme@asiaticexp.com','subrata@asiaticexp.com','shemul.gpme@asiaticexp.com','riadbiswas03@gmail.com','abu.rayhan@grameenphone.com','a_amin@grameenphone.com','nsarker@grameenphone.com']
    to_emails = []  # ⚠️ Fill in recipient emails before running
    # cc_emails = ['mahamudul@grameenphone.com','jubair.ovi@v2.ltd']
    cc_emails = []  # ⚠️ Fill in CC emails before running
